...
const STRENGTHS: { i: string; title: string; body: string }[] = [
  ...
  {
    i: "03",
    title: "Антидетект уже внутри",
    body: "У каждого аккаунта свой отпечаток, прокси и cookies — как с отдельного устройства. Отдельный платный антидетект не нужен.",
  },
  {
    i: "04",
  ...
  },
  {
    i: "05",
    title: "Всё в одном",
    body: "Больше не жонглируешь антидетект-браузером, таблицами и ручными кликами в Facebook. Всё в одной программе.",
  },
  {
    i: "06",
    title: "Скорость",
...
const FEATURES: { title: string; body: string }[] = [
  ...
  {
    title: "Антидетект внутри",
    body: "Каждый аккаунт работает как с отдельного устройства: свой отпечаток, прокси и cookies. Без отдельных программ.",
  },
  {
...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Нет. Антидетект встроен: у каждого аккаунта свой отпечаток, прокси и cookies. Платить отдельно за Dolphin / Octo / AdsPower больше не нужно.",
  },
  {
          ...
          <div>
            ...
            <Reveal delay={160}>
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-haze">
                DrunkCtrl ведёт твои рекламные аккаунты за тебя: проверяет, готовит и
                запускает рекламу — массово, в один клик. Антидетект уже внутри, всё
                работает на твоём компьютере. Никакой абонентки за каждый аккаунт.
              </p>
            </Reveal>
            <Reveal delay={240}>
        ...
        <section id="pricing" className="scroll-mt-20 border-t border-line py-24">
          <Reveal>
            ...
            <p className="mx-auto mt-4 max-w-md text-center text-haze">
              Без урезанных тарифов и без доплат за количество аккаунтов.
            </p>
          </Reveal>
          <Reveal delay={120}>
              ...
              <div className="relative overflow-hidden rounded-3xl border border-indigo/40 bg-gradient-to-b from-surface to-ink p-8 shadow-[0_30px_90px_-30px_rgba(79,70,229,0.6)]">
                ...
                <ul className="mt-7 space-y-3 text-sm">
                  {[
                    ...
                    "Антидетект, прокси и профили — уже внутри",
